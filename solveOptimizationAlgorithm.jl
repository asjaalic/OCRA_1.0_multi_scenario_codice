...
function solveOptimizationProblem(InputParameters::InputParam, SolverParameters::SolverParam, Battery::BatteryParam, NScen, Results_ex_post::results_ex_post)
    ...
    for iScen=1:NScen
        ...
        problem = BuildStageProblem(InputParameters, SolverParameters, Battery, NSteps_sim, vector_stages_index, iScen, vector_prices)
