function data_saving(InputParameters::InputParam, ResultsOpt::Results, Results_ex_post::results_ex_post, Results_statistics::Data_analysed, Battery::BatteryParam,  NScen)

    @unpack (NYears, NMonths, NStages, Big, NHoursStep, disc) = InputParameters;       #NSteps,NHoursStage
    @unpack (charge, discharge, rev, cap, soc, soc_quad, deg, deg_stage, WEM_stage, cost_rev, net_revenues_per_stage) = ResultsOpt;
    ...
    for iScen=1:NScen
            ...
            hourly_results[!, "Degradation MWh"] = deg[iScen][:]
